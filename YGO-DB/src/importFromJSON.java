...
public class importFromJSON {
	...
	public static void main(String[] args) throws SQLException {
		...
		try {
			connection = DriverManager.getConnection("jdbc:sqlite:C:\\Users\\Mike\\eclipse-workspace\\ygodb\\YGO-DB\\YGO-DB.db");
	...
	static private void setStringOrNull(PreparedStatement s, int index, JSONObject current, String id) throws SQLException {
