...
public class FixMissingGamePlayCardFromCardSets {
	...
	public void run() throws SQLException, IOException {
		...
		for (String setName : setsList) {
			...
			for (int i : list) {
				ArrayList<String> titles = SQLiteConnection.getMultiCardTitlesFromID(i);
				
				ArrayList<CardSet> cardSets = SQLiteConnection.getAllCardSetsOfCardByIDAndSet(i, setName);
				...
				if(titles == null || titles.size() == 0) {
					...
					SQLiteConnection.replaceIntoGamePlayCard(current);
				}
